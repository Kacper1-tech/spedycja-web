  ...
  return (
    <div className="max-w-xl mx-auto bg-white shadow p-6 rounded">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* Nazwa sprzedawcy */}
        <div>
          <label htmlFor="sellerName" className="block mb-1 font-semibold">
            Nazwa sprzedawcy
          </label>
          <input
            id="sellerName"
        ...
        {/* Nr faktury */}
        <div>
          <label htmlFor="invoiceNumber" className="block mb-1 font-semibold">
            Nr faktury
          </label>
          <input
            id="invoiceNumber"
        ...
        {/* Data płatności */}
        <div>
          <label htmlFor="paymentDate" className="block mb-1 font-semibold">
            Data płatności
          </label>
          <input
            id="paymentDate"
